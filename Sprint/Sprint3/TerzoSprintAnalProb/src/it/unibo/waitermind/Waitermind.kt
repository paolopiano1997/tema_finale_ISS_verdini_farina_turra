	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		...
		return { //this:ActionBasciFsm
				...
				state("checkIsTableStopped") { //this:State
					...
					transition(edgeName="t019",targetState="checkDirty",cond=whenDispatch("gotohome"))
				}	 
				state("checkDirty") { //this:State
					action { //it:State
						request("isDirty", "isDirty(dirty)" ,"tearoomstate" )  
					}
					 transition(edgeName="t020",targetState="finalCleanCheck",cond=whenReply("dirty"))
				}	 
				state("finalCleanCheck") { //this:State
					action { //it:State
						if( checkMsgContent( Term.createTerm("dirty(N)"), Term.createTerm("dirty(N)"), 
						                        currentMsg.msgContent()) ) { //set msgArgList
								if(  payloadArg(0) != "0"  
								 ){ CurTable = payloadArg(0).toString().toInt()  
								forward("gotoclean", "gotoclean(go)" ,"waitermind" ) 
								}
								else
								 {forward("gotohome", "gotohome(go)" ,"waitermind" ) 
								 }
					 ...
					 transition(edgeName="t021",targetState="reachhome",cond=whenDispatch("gotohome"))
					transition(edgeName="t022",targetState="reachTableClean",cond=whenDispatch("gotoclean"))
				}	 
				state("reachTableCleanStopped") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t023",targetState="cleanTable",cond=whenDispatch("done"))
				}	 
				state("take") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t024",targetState="checkTake",cond=whenReply("tableId"))
				}	 
				state("checkTake") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t025",targetState="waitOrder",cond=whenDispatch("done"))
				}	 
				state("waitOrder") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t026",targetState="transmit",cond=whenDispatch("order"))
				}	 
				...
				state("reachBarman") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t027",targetState="serve",cond=whenDispatch("done"))
				}	 
				state("serve") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t028",targetState="checkTableId",cond=whenReply("tableId"))
				}	 
				state("checkTableId") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t029",targetState="checkCleanHome",cond=whenDispatch("done"))
				}	 
				...
				state("reachTableCollect") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t030",targetState="checkCollect",cond=whenReply("tableId"))
				}	 
				state("checkCollect") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t031",targetState="collect",cond=whenDispatch("done"))
				}	 
				state("reachTableClean") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t032",targetState="cleanTable",cond=whenDispatch("done"))
				}	 
				...
				state("convoyToExitDoor") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t033",targetState="checkCleanHome",cond=whenDispatch("done"))
				}	 
				state("cleanTable") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t034",targetState="checkQueue",cond=whenDispatch("cleanerdone"))
					transition(edgeName="t035",targetState="accept",cond=whenRequest("enter"))
					transition(edgeName="t036",targetState="take",cond=whenDispatch("clientready"))
					transition(edgeName="t037",targetState="reachTableCollect",cond=whenDispatch("timePassed"))
					transition(edgeName="t038",targetState="reachBarman",cond=whenDispatch("drinkready"))
					transition(edgeName="t039",targetState="reachTableCollect",cond=whenDispatch("paymentready"))
				}	 
				state("checkQueue") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t040",targetState="checkTables",cond=whenReply("table"))
					transition(edgeName="t041",targetState="checkCleanHome",cond=whenDispatch("gotohome"))
				}	 
