		...
		return { //this:ActionBasciFsm
				...
				state("wait") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t082",targetState="prepare",cond=whenDispatch("order"))
				}	 
				state("prepare") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t083",targetState="done",cond=whenTimeout("local_tout_barman_prepare"))   
				}	 
				state("done") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t084",targetState="wait",cond=whenDispatch("take"))
				}	 
			}
		}
}
