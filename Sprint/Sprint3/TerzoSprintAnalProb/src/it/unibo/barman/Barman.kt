		...
		return { //this:ActionBasciFsm
				...
				state("wait") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t070",targetState="prepare",cond=whenDispatch("order"))
				}	 
				state("prepare") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t071",targetState="done",cond=whenTimeout("local_tout_barman_prepare"))   
				}	 
