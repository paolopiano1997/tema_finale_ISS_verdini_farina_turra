		...
		return { //this:ActionBasciFsm
				...
				state("wait") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t033",targetState="start",cond=whenDispatch("starttimer"))
				}	 
				state("start") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t034",targetState="timeFinish",cond=whenTimeout("local_tout_timer_start"))   
					transition(edgeName="t035",targetState="stop",cond=whenRequest("stoptimer"))
				}	 
