		...
		return { //this:ActionBasciFsm
				...
				state("wait") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t033",targetState="preDirty",cond=whenDispatch("startcleaner"))
					transition(edgeName="t034",targetState="wait",cond=whenRequest("isTableStopped"))
				}	 
				state("timerStop") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t035",targetState="stop",cond=whenReply("okStop"))
				}	 
				state("stop") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t036",targetState="preStart",cond=whenDispatch("startcleaner"))
					transition(edgeName="t037",targetState="replyTableStop",cond=whenRequest("isTableStopped"))
				}	 
				...
				state("preStart") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t038",targetState="checkState",cond=whenReply("state"))
				}	 
				state("checkState") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t039",targetState="cleanDirty",cond=whenDispatch("gotodirty"))
					transition(edgeName="t040",targetState="cleanUndirty",cond=whenDispatch("gotoundirty"))
					transition(edgeName="t041",targetState="cleanSanitized",cond=whenDispatch("gotosanitized"))
				}	 
				...
				state("cleanDirty") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t042",targetState="preUndirty",cond=whenDispatch("endtime"))
					transition(edgeName="t043",targetState="timerStop",cond=whenDispatch("stopcleaner"))
					transition(edgeName="t044",targetState="cleanDirty",cond=whenRequest("isTableStopped"))
				}	 
				state("cleanUndirty") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t045",targetState="preSanitized",cond=whenDispatch("endtime"))
					transition(edgeName="t046",targetState="timerStop",cond=whenDispatch("stopcleaner"))
					transition(edgeName="t047",targetState="cleanUndirty",cond=whenRequest("isTableStopped"))
				}	 
				state("cleanSanitized") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t048",targetState="cleanDone",cond=whenDispatch("endtime"))
					transition(edgeName="t049",targetState="timerStop",cond=whenDispatch("stopcleaner"))
					transition(edgeName="t050",targetState="cleanSanitized",cond=whenRequest("isTableStopped"))
				}	 
