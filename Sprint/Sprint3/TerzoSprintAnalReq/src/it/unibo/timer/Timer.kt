		...
		return { //this:ActionBasciFsm
				...
				state("wait") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t030",targetState="start",cond=whenDispatch("starttimer"))
				}	 
				state("start") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t031",targetState="timeFinish",cond=whenTimeout("local_tout_timer_start"))   
					transition(edgeName="t032",targetState="stop",cond=whenRequest("stoptimer"))
				}	 
