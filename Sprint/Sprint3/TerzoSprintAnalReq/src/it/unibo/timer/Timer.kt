		...
		return { //this:ActionBasciFsm
				...
				state("wait") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t029",targetState="start",cond=whenDispatch("starttimer"))
				}	 
				state("start") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t030",targetState="timeFinish",cond=whenTimeout("local_tout_timer_start"))   
					transition(edgeName="t031",targetState="stop",cond=whenRequest("stoptimer"))
				}	 
