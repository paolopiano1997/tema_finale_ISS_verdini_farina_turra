		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t058",targetState="started",cond=whenRequest("start"))
				}	 
				...
				state("wait") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t059",targetState="planmove",cond=whenDispatch("moveto"))
					transition(edgeName="t060",targetState="wait",cond=whenDispatch("stopengine"))
				}	 
				...
				state("execPlanMove") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t061",targetState="nextStep",cond=whenTimeout("local_tout_waiterengine_execPlanMove"))   
					transition(edgeName="t062",targetState="stop",cond=whenDispatch("stopengine"))
				}	 
				...
				state("execStep") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t063",targetState="stepDone",cond=whenReply("stepdone"))
					transition(edgeName="t064",targetState="stepFailed",cond=whenReply("stepfail"))
				}	 
